...
- [Sentry local-vars PII leak](project-sentry-local-vars-pii.md) — sentry_sdk.init must set include_local_variables=False; send_default_pii=False + contact-redactor before_send do NOT cover stack-frame locals holding chat/CV free text
